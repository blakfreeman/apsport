...
// get users the collection location reference or query
  ...
  Widget build(BuildContext context) {
      ...
      body:  StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            return new ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) =>//to return the users matching current user sport
    ...
    Widget buildUserCard(BuildContext context, DocumentSnapshot users) {
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Row(children: <Widget>[
                      Text(users['sport'], style: new TextStyle(fontSize: 30.0),),
                      Spacer(),
                      Text(users['username'], style: new TextStyle(fontSize: 15.0),),
